...
const AddPublication = () => {
  ...
  const handleAddNewSkill = (e) => {
    ...
    formData.append("publication", svg); // Changed from "svg" to "publication"

    dispatch(addNewPublication(formData));
  };
      ...
      <form onSubmit={handleAddNewSkill} className="w-[100%] px-5 md:w-[650px]">
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          {!loading ? (
            ...
            <SpecialLoadingButton content={"Adding New Publication"} />
          )}
        </div>
      </form>
    </div>
