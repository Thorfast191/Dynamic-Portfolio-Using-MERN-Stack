...
const AddSoftwareApplications = () => {
  ...
  const handleAddSoftwareApp = async (e) => {
    ...
    console.log("Submitting form with:", { name, svg });
    await dispatch(addNewSoftwareApplication(formData));
  };

  useEffect(() => {
    console.log("State changed:", { error, message, loading });
    if (error) {
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            {!loading ? (
              ...
              <SpecialLoadingButton
                content={"Adding New Software Application"}
              />
            )}
          </div>
        </form>
