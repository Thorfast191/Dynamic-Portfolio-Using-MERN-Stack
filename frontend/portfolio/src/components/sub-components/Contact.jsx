    ...
    <div className="relative max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="relative mb-12">
        ...
        <div className="absolute -top-12 left-1/4 w-20 h-16">
          <div className="absolute top-0 left-1/2 w-[2px] h-10 bg-gradient-to-b from-transparent via-sky-400 to-transparent animate-pulse" />
          <div className="absolute top-6 left-1/2 transform -translate-x-1/2 w-16 h-[1px] bg-gradient-to-r from-transparent via-sky-400 to-transparent animate-pulse" />
        </div>

        <div className="absolute -top-12 right-1/4 w-20 h-16">
          <div
            className="absolute top-0 right-1/2 w-[2px] h-10 bg-gradient-to-b from-transparent via-sky-400 to-transparent animate-pulse"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute top-6 right-1/2 transform translate-x-1/2 w-16 h-[1px] bg-gradient-to-l from-transparent via-sky-400 to-transparent animate-pulse"
        ...
        >
          ...
          <div className="relative h-2 bg-gray-800/50 rounded-full overflow-hidden">
            <div className="absolute inset-0 flex">
              {[...Array(10)].map((_, i) => (
                <div
                  key={i}
                  className="h-full w-4 bg-gradient-to-r from-sky-400 to-blue-400 animate-pulse"
                  style={{
          ...
          <div className="flex justify-center pt-4">
            {!loading ? (
              <Button
                type="submit"
                className="btn-space px-10 py-7 text-lg font-tech-heading tracking-wider relative group overflow-hidden bg-sky-600 hover:bg-sky-700"
              >
                {/* Button glow */}
              ...
              <div className="relative">
                <button
                  disabled
                  type="button"
                  className="btn-space px-10 py-7 text-lg font-tech-heading tracking-wider relative overflow-hidden flex items-center gap-3 bg-sky-600"
                >
                  {/* Transmission animation */}
                  <div className="absolute inset-0 bg-gradient-to-r from-sky-500/0 via-sky-500/30 to-sky-500/0" />
      ...
      <div className="mt-12 text-center font-tech-body text-gray-300">
        ...
        <p className="text-sm text-gray-400">
          Your message will be received via secure space communication protocol
        </p>
      </div>

      {/* Contact info */}
      <div className="mt-16 text-center text-gray-300 max-w-2xl mx-auto">
